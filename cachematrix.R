## Coursera R Programming Assignment 2       Richard Ellison 3/18/2015
...
## a<- makeCacheMatrix(matrix(c(1,2,12,13),nrow=2,ncol=2))  # this must be a square
                                  # matrix because solve only handles square matrices
## summary(a)
## a$get()
## cacheSolve(a)    ## first time calcs value
## cacheSolve(a)    ## second time gets cached value